(function() {
    class Lightbox {
      ...
      handleImageClick(event) {
        ...
        // 只接管正文/表格内的图片。顶部导航 logo、头像、图标等界面图片
        // 必须保留原有行为（例如 <a class="kc-brand"> 的跳转），
        // 因此先判定归属，确认要接管后再 preventDefault。
        const images = Array.from(document.querySelectorAll('.markdown-body img, table img'));
